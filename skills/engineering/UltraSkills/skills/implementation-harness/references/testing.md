...
- Do not claim completion without at least one meaningful verification step. If the environment or dependencies prevent it, report a `NON_BLOCKING_STOP` and request help.
...
Report a `NON_BLOCKING_STOP` when:
