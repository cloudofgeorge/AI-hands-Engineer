...
Then explore the codebase systematically, using available agentic/codebase tools when helpful. Don't follow rigid heuristics — explore organically and note where you experience friction:
