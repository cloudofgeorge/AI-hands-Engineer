...
| --- | ---: | --- |
| [Brainstorming](./brainstorming/README.md) | 1 | Idea shaping, requirement discovery, approach comparison, and design approval before creative implementation work. |
